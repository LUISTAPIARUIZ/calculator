...
let btnCancelarAnimacion=document.getElementById("btnCancelarAnimacion");
let imgCarro= document.getElementById("img__carro");
let setTimeCancelarAnimacion;
...
const animacion = (tiempo)=>{
    ...
    btnCancelarAnimacion.setAttribute("style","display:flex")
    imgCarro.setAttribute("style", `transition:${tiempo}s`);
    imgCarro.classList.add("mover-carro")
    setTimeCancelarAnimacion=setTimeout(function(){
    botonCalcular.setAttribute("style","display:flex");
    btnCancelarAnimacion.setAttribute("style","display:none")
    imgCarro.setAttribute("style", `transition:0s`);
    imgCarro.classList.remove("mover-carro")
    },tiempo*1000)
}
btnCancelarAnimacion.addEventListener("click",function(){
    clearTimeout(setTimeCancelarAnimacion);
    botonCalcular.setAttribute("style","display:flex");
    btnCancelarAnimacion.setAttribute("style","display:none")
    imgCarro.setAttribute("style", `transition:0s`);
    imgCarro.classList.remove("mover-carro")
