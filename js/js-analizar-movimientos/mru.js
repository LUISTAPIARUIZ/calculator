...
botonCalcular.addEventListener("click",function(){
    ...
    let imgCarro= document.getElementById("img__carro");
    btnCancelarAnimacion.style.display="flex";
